...
<head>
    <meta charset="utf-8" />
    <title>NOC তালিকা - খুলনা বিশ্ববিদ্যালয় স্কুল</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-3 mb-3">
                        <div class="card-body">
                            <div>
                                <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModal">NOC যুক্ত করুন</button>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="myModalLabel">NOC যুক্ত করুন</h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    $no = $db_handle->numRows("select * from noc");
                                    for ($i=0; $i<$no; $i++){
                                        ?>
                                        <tr>
                                            <td><?php echo $i+1;?></td>
                                            <td><?php echo $fetch_noc[$i]['title'];?></td>
                                            <td><?php
                                                $joinDateStr = $fetch_noc[$i]['date'];
                                                $joinDate = new DateTime($joinDateStr);
                                                echo $formattedDate = date_format($joinDate, 'd M, Y');?></td>
                                            <td>
                                                <a href="Edit_NOC?id=<?php echo $fetch_noc[$i]['noc_id'];?>"><i data-feather="pen-tool"></i></a>
                                                <a href="Delete?noc_id=<?php echo $fetch_noc[$i]['noc_id'];?>"><i data-feather="trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
