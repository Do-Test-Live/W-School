...
<head>
    <meta charset="utf-8" />
    <title>কর্মচারী তালিকা - খুলনা বিশ্ববিদ্যালয় স্কুল</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">কর্মচারী তালিকা</h4>
                                                ...
                                                <form action="Insert" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="text-center mt-4">
                                                        ...
                                                        <button type="submit" class="btn btn-primary waves-effect waves-light"
                                                                name="insert_stuff">সংরক্ষন করুন
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                    <?php
                                    $fetch_staff = $db_handle->runQuery("select * from staffs");
                                    ...
                                    for ($i=0; $i<$no; $i++){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $fetch_staff[$i]['position'];?></td>
                                            <td><?php
                                                $joinDateStr = $fetch_staff[$i]['join_date'];
                                                $joinDate = new DateTime($joinDateStr);
                                                echo $formattedDate = date_format($joinDate, 'd M, Y');?></td>
                                            <td><?php
                                                if($fetch_staff[$i]['present'] == 'on'){
                                                    echo 'এখনও কর্মরত';
                                                }else{
                                                    $joinDateStr = $fetch_staff[$i]['leave_date'];
                                                    $joinDate = new DateTime($joinDateStr);
                                                    echo $formattedDate = date_format($joinDate, 'd M, Y');
                                                }
                                                ?></td>
                                            <td><a href="Edit_Staffs?id=<?php echo $fetch_staff[$i]['id'];?>"><i data-feather="pen-tool"></i></a></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
