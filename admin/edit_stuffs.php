...
<head>
    <meta charset="utf-8" />
    <title>কর্মচারী তথ্য সম্পাদন - খুলনা বিশ্ববিদ্যালয় স্কুল</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">কর্মচারী তথ্য সম্পাদন</h4>
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">খুলনা বিশ্ববিদ্যালয় স্কুল</a></li>
                                    <li class="breadcrumb-item active">কর্মচারী তথ্য সম্পাদন</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <div>
                                    <form action="Update" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <?php
                                            $fetch = $db_handle->runQuery("select * from staffs where id = {$_GET['id']}");
                                            ?>
                                        ...
                                        <div class="text-center mt-4">
                                            <button type="submit" class="btn btn-primary waves-effect waves-light"
                                                    name="update_staff">সংরক্ষন করুন
                                            </button>
                                        </div>
                                    </form>
                                </div>
