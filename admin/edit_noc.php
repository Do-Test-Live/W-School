...
<head>
    <meta charset="utf-8" />
    <title>NOC তথ্য সম্পাদন - খুলনা বিশ্ববিদ্যালয় স্কুল</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">NOC তথ্য সম্পাদন</h4>
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">খুলনা বিশ্ববিদ্যালয় স্কুল</a></li>
                                    <li class="breadcrumb-item active">NOC তথ্য সম্পাদন</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <div>
                                    <form action="Update" method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label for="example-text-input" class="form-label">ফাইল</label>
                                            <input class="form-control" type="file" id="example-text-input"
                                                   name="image" accept="application/pdf">
                                        </div>
                                        <div class="mb-3">
                                            <?php
                                            $fetch = $db_handle->runQuery("select * from noc where noc_id = {$_GET['id']}");
                                            ?>
                                            <div class="mb-3">
                                                <iframe src="<?php echo $fetch[0]['file'];?>" width="500" height="500"></iframe>
                                            </div>
                                        </div>
                                        <input type="hidden" value="<?php echo $fetch[0]['noc_id'];?>" name="id"/>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="date" id="example-text-input"
                                                   name="date" value="<?php echo $fetch[0]['date'];?>" required>
                                        </div>
                                        <div class="text-center mt-4">
                                            <button type="submit" class="btn btn-primary waves-effect waves-light"
                                                    name="update_noc">সংরক্ষন করুন
                                            </button>
                                        </div>
                                    </form>
                                </div>
