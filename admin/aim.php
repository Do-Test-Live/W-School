...
<head>
    <meta charset="utf-8"/>
    <title>লক্ষ্য ও উদ্দেশ্য - খুলনা বিশ্ববিদ্যালয় স্কুল</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">লক্ষ্য ও উদ্দেশ্য</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">খুলনা বিশ্ববিদ্যালয়
                                            স্কুল</a></li>
                                    <li class="breadcrumb-item active">লক্ষ্য ও উদ্দেশ্য</li>
                                </ol>
                            </div>
                            ...
                            <div class="col-12">
                                <div>
                                    <form action="Update" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <?php
                                            $fetch_about_image = $db_handle->runQuery("select * from aim where id = '1'");
                                            ?>
