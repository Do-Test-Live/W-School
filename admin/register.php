...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin Register - Khulna University School</title>
                    ...
                    <div class="w-100">
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                ...
                                <form class="needs-validation mt-4 pt-2" action="Insert" method="post">
                                    <div class="mb-3">
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Khulna University School</p>
                            </div>
                        </div>
                    </div>
                </div>
