...
<head>
    <meta charset="utf-8" />
    <title>সভাপতির তালিকা - খুলনা বিশ্ববিদ্যালয় স্কুল</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">সভাপতির তালিকা</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">খুলনা বিশ্ববিদ্যালয় স্কুল</a></li>
                                    <li class="breadcrumb-item active">সভাপতির তালিকা</li>
                                </ol>
                            </div>
                                                ...
                                                <form action="Insert" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="text-center mt-4">
                                                        ...
                                                        <button type="submit" class="btn btn-primary waves-effect waves-light"
                                                                name="insert_chairman">সংরক্ষন করুন
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                    <?php
                                    $fetch_chairman = $db_handle->runQuery("select * from chairman_list");
                                    $no = $db_handle->numRows("select * from chairman_list");
                                    for ($i=0; $i<$no; $i++){
                                        ?>
                                        <tr>
                                            <td><?php echo $i+1;?></td>
                                            <td><?php echo $fetch_chairman[$i]['chairman_name'];?></td>
                                            <td><img src="<?php echo $fetch_chairman[$i]['image'];?>" height="50px"></td>
                                            <td><?php
                                                $joinDateStr = $fetch_chairman[$i]['join_date'];
                                                $joinDate = new DateTime($joinDateStr);
                                                echo $formattedDate = date_format($joinDate, 'd M, Y');?></td>
                                            <td><?php
                                                if($fetch_chairman[$i]['present'] == 'on'){
                                                    echo 'এখনও কর্মরত';
                                                }else{
                                                    $joinDateStr = $fetch_chairman[$i]['leave_date'];
                                                    $joinDate = new DateTime($joinDateStr);
                                                    echo $formattedDate = date_format($joinDate, 'd M, Y');
                                                }
                                               ?></td>
                                            <td><a href="Edit_Chairman_List?id=<?php echo $fetch_chairman[$i]['id'];?>"><i data-feather="pen-tool"></i></a></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
